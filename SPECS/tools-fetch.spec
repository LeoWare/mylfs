...
#MD5SUM:	d92afb0c6e8e616792068ee4737b0d24;SOURCES/udev-lfs-20171102.tar.bz2
...
#
#		Added packages for rpm and wget
#
...
#TARBALL:	http://www.linuxfromscratch.org/patches/blfs/8.1/openssh-7.5p1-openssl-1.1.0-1.patch
#MD5SUM:	ba5f1b8b835b88cadbce9b35ed9531a6;SOURCES/openssl-1.1.0g.tar.gz
#TARBALL:	https://ftp.gnu.org/gnu/wget/wget-1.19.1.tar.xz
#MD5SUM:	d30d82186b93fcabb4116ff513bfa9bd;SOURCES/wget-1.19.1.tar.xz
#-----------------------------------------------------------------------------
Summary:	Meta rpm to fetch all the source files
Name:		tools-fetch
Version:	8.2
Release:	1
License:	None
...
Vendor:	Octothorpe
%description
	Meta rpm to fetch all the source files
#-----------------------------------------------------------------------------
%prep
%build
%install
%files
%changelog
*	Tue Jan 09 2018 baho-utot <baho-utot@columbus.rr.com> 8.2-1
